...
"""
# for saving
s_path = '/project/6015947/yxu233/MyelinUNet_new/Checkpoints/Check_MyQz13_both_fibers/'
...
#        plt.pause(0.05); 
        ...
        if len(batch_x) == batch_size:
           ...
           feed_dict_CROSSVAL = {x:batch_x_val, y_:batch_y_val, training:0, weight_matrix:weights_val}      
