...
- other to-do's
    - less stupid variable names (lol sorry) 
    - reduce importing (did not realize you can import specific fnxs rather than whole modules)
    - make bigger function that randomly applies these to subsets of images
"""
...
# did not bother making a function here as clearly it already exists and works fine
blur = 2
...
def changeContrast(cont1,cont2):
...
def changeStretch(stretch1,stretch2):
    import skimage.transform
    if stretch1 == 1:
