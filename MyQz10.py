...
# Read in file names
myzip = zipfile.ZipFile(input_path + 'Checkpoints.zip', 'r')
...
#        plt.pause(0.05); 
        ...
        if len(batch_x) == batch_size:
           feed_dict_TRAIN = {x:batch_x, y_:batch_y, training:1, weight_matrix:weighted_labels}                 
           feed_dict_CROSSVAL = {x:batch_x_val, y_:batch_y_val, training:0, weight_matrix:weighted_labels}      
