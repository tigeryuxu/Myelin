...
# for input
input_path = 'D:/Tiger/AI stuff/OUTPUT_MATLAB_2/'
# for validation
val_input_path='D:/Tiger/AI stuff/OUTPUT_MATLAB_2/For_zipping/'
...
for T in range(len(onlyfiles_val)):
    ...
    input_val, truth_val = load_training(val_input_path, filename)
...
#        plt.pause(0.05); 
        ...
        if len(batch_x) == batch_size:
           ...
           if epochs % 10 == 0:
              ...
              """ GET VALIDATION """
              batch_x_val_fibers, batch_y_val_fibers, batch_weights_fibers = get_batch_val_normal(val_input_path, onlyfiles_val, counter_fibers, mean_arr, std_arr, 
