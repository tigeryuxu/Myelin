...
"""
# for saving
s_path = '/project/6015947/yxu233/MyelinUNet_new/Checkpoints/Check_MyQz15_QL_classW/'
# for input
...
# for saving
s_path = 'C:/Users/Neuroimmunology Unit/Anaconda3/AI stuff/MyelinUNet/Checkpoints/Check_MyQz15_QL_classW_by_3_full/'
# for input
...
#        plt.pause(0.05); 
        ...
        if len(batch_x) == batch_size:
           feed_dict_TRAIN = {x:batch_x, y_:batch_y}                 
           ...
           if epochs % 10 == 0:
              ...
              feed_dict_CROSSVAL = {x:batch_x_val, y_:batch_y_val}      
