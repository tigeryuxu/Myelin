...
function diameter_F_Callback(hObject, eventdata, handles)
% hObject    handle to diameter_F (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of diameter_F as text
%        str2double(get(hObject,'String')) returns contents of diameter_F as a double


% --- Executes during object creation, after setting all properties.
function diameter_F_CreateFcn(hObject, eventdata, handles)
% hObject    handle to diameter_F (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function DAPIsize_Callback(hObject, eventdata, handles)
% hObject    handle to DAPIsize (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of DAPIsize as text
%        str2double(get(hObject,'String')) returns contents of DAPIsize as a double


% --- Executes during object creation, after setting all properties.
function DAPIsize_CreateFcn(hObject, eventdata, handles)
% hObject    handle to DAPIsize (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in load_p.
function load_p_Callback(hObject, eventdata, handles)
% hObject    handle to load_p (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

[filename, path, x] = uigetfile();
filepath = strcat(path, filename);
load(filepath);
set((handles.name), 'String', save_params{1});
set((handles.batch), 'String', save_params{2});
set((handles.scale), 'String', save_params{3});
set((handles.diameter_F), 'String', save_params{4});
set((handles.sigma), 'String', save_params{5});
set((handles.sensitivity), 'String', save_params{6});
...
save_params = cell(0);
save_params{1} = get((handles.name), 'String');
save_params{2}= get((handles.batch), 'String');
save_params{3}= str2num(get((handles.scale), 'String'));
save_params{4} = str2num(get((handles.diameter_F), 'String'));
save_params{5} = str2num(get((handles.sigma), 'String'));
save_params{6}= str2num(get((handles.sensitivity), 'String'));
...
foldername = uigetdir();
cd(foldername);
save('save_params.mat', 'save_params');
cd(cur_dir);
...
% Hint: get(hObject,'Value') returns toggle state of match_full_name
...
% Hint: get(hObject,'Value') returns toggle state of calib
...
% --- Executes on button press in Nano_YN.
function Nano_YN_Callback(hObject, eventdata, handles)
% hObject    handle to Nano_YN (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of Nano_YN


% --- Executes on button press in Combine_RG.
function Combine_RG_Callback(hObject, eventdata, handles)
% hObject    handle to Combine_RG (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of Combine_RG
