...
% Add some contents
uicontrol( 'Style', 'edit', 'String', 'Button 1', 'Parent', panel{1} );
uicontrol( 'Style', 'checkbox', 'String', 'Button 2', 'Parent', panel{2} );
uicontrol( 'Style', 'PushButton', 'String', 'Proceed', 'Parent', panel{3} );
...
%-------------------------------------------------------------------------%
 ...
 %---------------------------------------------------------------------%
    function run(eventSource, eventData, whichpanel)
       i = 1
    end
